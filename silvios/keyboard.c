...
{	0x32,	0x22/*0x40*/,	0x0300,	0x7900,	0x32,	0x32,	0x40,		0x40},
{	0x33,	0x26/*0x23*/,	0,	0x7A00, 0x33,	0x33,	0x23,		0x23},
{	0x34,	0x24,	0,	0x7B00, 0x34,	0x34,	0x24,		0x24},
{	0x35,	0x25,	0,	0x7C00,	0x35,	0x35,	0x25,		0x25},
{	0x36,	0x26/**/,	0x1E,	0x7D00, 0x36,	0x36,	0x5E,		0x5E},
{	0x37,	0x2F/*0x26*/,	0,	0x7E00,	0x37,	0x37,	0x26,		0x26},
{	0x38,	0x28/*0x2A*/,	0,	0x7F00, 0x38,	0x38,	0x2A,		0x2A},
{	0x39,	0x29/*0x28*/,	0,	0x8000, 0x39,	0x39,	0x28,		0x28},
{	0x30,	0x3D/*0x29*/,	0,	0x8100,	0x30,	0x30,	0x29,		0x29},
/* -, =, Bksp, Tab */
{	0x27/*0x2D*/,	0x3F/*0x5F*/,	0x1F,	0x8200,	0x2D,	0x2D,	0x5F,		0x5F},
{	0xA1/*x3D*/,	0x5E/*0x2B*/,	0,	0x8300,	0x3D,	0x3D,	0x2B,		0x2B},
...
{	0x8A/*0x5B*/,0x82,/*	0x7B*/	0x1B,	0x0,	0x5B,	0x5B,	0x7B,		0x7B},
{	0x2B/*0x5D*/,	0x2A/*0x7D*/,	0x1D,	0,	0x5D,	0x5D,	0x7D,		0x7D},
/* ENTER, CTRL */
...
{	0x95,	0x80,	0,	0,	0x3B,	0x3B,	0x3A,		0x3A},
{	0x85,	0xA7,	0,	0,	0x27,	0x27,	0x22,		0x22},
{	0x5C,	0x7C,	0x1C,	0,	0x5C,	0x5C,	0x7C,		0x7C},
/* Left Shift*/
{	0x2A,	0,	0,	0,	0,	0,	0,		0},
/* \ZXCVBNM,./ */
{	0x97,	0xF5,	0,	0,	0x60,	0x60,	0x7E,		0x7E},
...
{	0x2C,	0x3B,	0,	0,	0x2C,	0x2C,	0x3C,		0x3C},
{	0x2E,	0x3A/*0x3E*/,	0,	0,	0x2E,	0x2E,	0x3E,		0x3E},
{	0x2D,	0x5F	,	0,	0,	0x2F,	0x2F,	0x3F,		0x3F},
/* Right Shift */
{	0,	0,	0,	0,	0,	0,	0,		0},
/* Print Screen */
{	0,	0,	0,	0,	0,	0,	0,		0},
...
void keyb_handler(void)
{
	...
	if(key_ascii != 0)
	{
		if(key_ascii <= 0xFF)
		{
			keyboard_buffer[peppe] = key_ascii;
			peppe++;
		}
		else
		{			keyboard_buffer[peppe] = (key_ascii & 0xFF);

			keyboard_buffer[peppe] = (key_ascii & 0xFF);
			keyboard_buffer[peppe+1] = (key_ascii & 0xFF00);
			peppe += 2;
		}
	}
