	...
	namespace driver{
		...
		namespace video{
			...
			public:
				...
				static int getX(); //Leggo la posizione del cursore dal lato sinistro dello schermo
				
				static int getY(); //Leggo la posizione del cursore dal lato sopra dello schermo
