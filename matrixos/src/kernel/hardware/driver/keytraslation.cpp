/*
	...
	|		MatrixOS		|
	+---------------------------------------+
	| Filename: keytraslation.cpp		|
	| Date: 31/12/2004			|
	| Authors: See the AUTHOR file		|
	| License: GNU General Public License	|
	+---------------------------------------+
	| Parte del codice e' copiato da 	|
	| ItaliOS.				|
	+.......................................+
*/ 
...
/*
  Inizializzo la mappa della tastiera
*/
void KeyTraslation::InitMap(void)
{
	my_opt.shift = false;
	my_opt.ctrl = false;
	my_opt.alt = false;
...
/*
  Converto uno scancode in un codice ASCII
*/
int KeyTraslation::Scan2Ascii(int car){
	//kout << "Sono lo scancode: " << car << endl;
	switch (car) {
	case NO_VALID_SCANDODE:
	...
	case 58:		//è stato premuto caps lock
		//kservices::KDbg::WriteLine(my_opt.caps_lock);
